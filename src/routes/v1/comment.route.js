...
router.route('/:campaignId').post(auth(), validate(commentValidation.createComment), commentController.createComment);
 ...
 *     description: Only registered Users can create comments.
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Only users/admins can retrieve all comments.
 *     tags: [Comments]
 *     parameters:
 *       - in: query
 *         name: name
 ...
 *     description: Logged in users can delete only their own comment. Only admins can delete other comments.
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     parameters:
