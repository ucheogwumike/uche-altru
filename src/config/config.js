...
const envVarsSchema = Joi.object()
  .keys({
    ...
    PAYSTACK_SECRET: Joi.string().required().description('PAYSTACK secret key'),
    LIVE_APP_URL: Joi.string().description('the live app url'),
    FRONTEND_URL: Joi.string().description('the live app url'),
  })
  .unknown();
